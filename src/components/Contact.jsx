...
import resume from '../media/HR2.pdf';
							...
							<Card className="nbcard">
								<Card.Body>
									...
									<Row className="margin10">
										<a
											href="https://www.linkedin.com/in/somashekar-s-r-9945268086/"
											target="_blank"
									...
									<Row className="margin10">
										<a
											href="https://github.com/Somashekar9999"
											target="_blank"
											rel="noreferrer noopener"
										>
											<Button
									...
									<Row className="margin10">
										<a href="mailto:Srsandeep819@gmail.com" target="_blank">
											<Button
												variant={
													darkMode
														? 'outline-light'
											...
											>
												<FontAwesomeIcon
													...
													icon={faEnvelope}
												/>{' '}
												Srsandeep819@gmail.com
											</Button>
										</a>
									</Row>
									<Row className="margin10">
										<a href="tel:+91 8197454354" target="_blank">
											<Button
												variant={
													darkMode
														? 'outline-light'
